...
export class AdvancedSettings extends LitElement {
  static get properties() {
    return {
      ...
      topK: { type: Number },
      bpm: { type: String },
      bpmAuto: { type: Boolean },
      density: { type: Number },
      densityAuto: { type: Boolean },
      brightness: { type: Number },
      brightnessAuto: { type: Boolean },
      muteBass: { type: Boolean },
      muteDrums: { type: Boolean },
      midiInputs: { type: Array },
      activeMidiInputId: { type: String },
  ...
  handleMidiChange(e) {
    ...
    this.dispatchEvent(new CustomEvent('midi-input-changed', { detail: select.value }));
  }
        ...
        <div class="content">
          ...
          <div class="section">
            ...
            <div class="control-row">
              ...
              <div style="display: flex; gap: 8px; align-items: center;">
                 ...
                 <label class="checkbox-row">
                    <input type="checkbox" ?checked=${this.bpmAuto} @change=${(e) => this.emitChange('bpmAuto', e.target.checked)}> Auto
                 </label>
              </div>
            </div>
            ...
            <div class="control-row">
              ...
              <input type="range" min="0" max="1" step="0.05" .value=${this.density} ?disabled=${this.densityAuto} @input=${(e) => this.emitChange('density', parseFloat(e.target.value))}>
              <label class="checkbox-row" style="justify-content: flex-end;">
                  <input type="checkbox" ?checked=${this.densityAuto} @change=${(e) => this.emitChange('densityAuto', e.target.checked)}> Auto
              </label>
            </div>
            ...
            <div class="control-row">
              ...
              <input type="range" min="0" max="1" step="0.05" .value=${this.brightness} ?disabled=${this.brightnessAuto} @input=${(e) => this.emitChange('brightness', parseFloat(e.target.value))}>
              <label class="checkbox-row" style="justify-content: flex-end;">
                  <input type="checkbox" ?checked=${this.brightnessAuto} @change=${(e) => this.emitChange('brightnessAuto', e.target.checked)}> Auto
              </label>
            </div>
          </div>
          ...
          <div class="section">
             ...
             <label class="checkbox-row">
                <input type="checkbox" ?checked=${this.muteBass} @change=${(e) => this.emitChange('muteBass', e.target.checked)}>
                Mute Bass Frequencies
             </label>
             <label class="checkbox-row">
                <input type="checkbox" ?checked=${this.muteDrums} @change=${(e) => this.emitChange('muteDrums', e.target.checked)}>
                Mute Percussion
             </label>
          </div>
          ...
          <div class="section">
            ...
            <div class="control-row">
              ...
              <input type="range" min="0" max="2" step="0.1" .value=${this.temperature} @input=${(e) => this.emitChange('temperature', parseFloat(e.target.value))}>
            </div>
          </div>
...
customElements.define('advanced-settings', AdvancedSettings);
